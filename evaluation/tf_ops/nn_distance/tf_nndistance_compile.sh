...
g++ -std=c++11 tf_nndistance.cpp tf_nndistance_g.cu.o -o tf_nndistance_so.so -shared -O2 -fPIC -I /usr/local/cuda/include -L/usr/local/cuda/lib64 ${TF_CFLAGS[@]} ${TF_LFLAGS[@]} -lcudart -I$TF_INC/external/nsync/public -ltensorflow_framework -L$TF_LIB -D_GLIBCXX_USE_CXX11_ABI=1
