...
def upsampling(data_paths: List[str], target_path: str, checkpoint_path: str, up_ratio: int, num_outlier: int, num_patch: int, num_upsampling: int=None, seed=None):
    ...
    pc_channel = 3
    network = PointInterpFlow(pc_channel)
...
if __name__ == "__main__":
    ...
    # usage: python models/interp/upsample.py --source=path/to/input --target=path/to/output --checkpoint=path/to/checkpoint --up_ratio=4 --num_out=20000
