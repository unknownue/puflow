...
import queue
import threading
from dataset.pugan import point_operation
...
def load_h5_data(h5_filename='', opts=None, skip_rate = 1, use_randominput=True):
    num_point = opts.num_point  # 256
    num_4X_point = int(opts.num_point * 4)  # 1024
    num_out_point = int(opts.num_point * opts.up_ratio)  # 1024 * 4
